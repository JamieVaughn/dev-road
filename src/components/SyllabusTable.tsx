...
const rows: Array<{
  ...
  },
  {
    level: ['i'],
    project: '',
    topic: 'Web Browsers & the Render Pipeline',
    hours: 3,
  },
  {
    level: ['i'],
  ...
  { level: ['i'], project: '', topic: 'GitHub & VSCode', hours: 6 },
  {
    ...
    topic: 'Individual Portfolio Project',
    hours: 3,
  },
  ...
  { level: ['ii'], project: '', topic: 'Asynchronous Javascript', hours: 12 },
  {
    level: ['ii'],
    project: '',
    topic: 'Version Control with Github',
    hours: 3,
  },
  {
    level: ['ii'],
    project: 'Incremental Clicker App',
  ...
  },
  {
    level: ['ii'],
    project: '',
    topic: 'Javascript Application Architecture',
    hours: 3,
  },
  {
    level: ['iii'],
    project: '',
    topic: 'Node.js, Git & the Terminal',
    hours: 3,
  },
  {
    level: ['iii'],
    project: '',
    topic: 'Intro to React & JS Frameworks',
    hours: 9,
  },
  ...
  {
    level: ['iii'],
    project: 'Database Read/Write App',
    topic: 'Databases & Authentication w/ Supabase',
    hours: 6,
  },
  {
    level: ['iii'],
    project: '',
    topic: 'Resume, Interviewing and Career Skills',
    hours: 3,
  },
]
...
export function SyllabusTable() {
  ...
  const [filteredRows, setFilteredRows] = createSignal(
    rows.filter((row) => row.level[0].length === level())
  )
  const [total, setTotal] = createSignal(
    filteredRows().reduce((acc, cur) => acc + cur.hours, 0)
  )
