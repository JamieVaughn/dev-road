...
export const outline_section_2 = [
  {
    topic: 'Variables, Primitives & Operators',
    key: `Show where we are on Roadmap.sh, History of Javascript & staying up to date with ES2021+
  ...
  },
  {
    ...
    key: `Array Method Student look up format
  functions
  Math API
  ...
  {
    topic: 'The DOM API',
    key: `querySelectors, NodeList vs HTML Collections
  ...
  {
    topic: 'Deep Objects',
    key: `Review dom api quiz & Conway game of life code along
  Prototypes
  ...
  {
    topic: 'ES Modules',
    key: `Modules code organization and closures
  ...
  {
    topic: 'Regex',
    key: `Regex Intro, up to regex/string methods
  regex online tools
  ...
  {
    topic: 'MVC pattern',
    key: `MVC slides, Design Patterns, Gang of four
  ...
  {
    topic: 'Promises',
    key: `Revisited Promises 1st concepts
  ...
  {
    topic: 'HTTP & Fetch',
    key: `HTTP APIs, CORS, reject(' received 404')
...
export const outline_section_3 = [
  ...
  },
  {
    ...
    key: `Templating languages & jsx spec
  writing jsx
  ...
  },
  {
    ...
    key: `separation of concerns: components
  ...
  },
  {
    ...
    key: `App shells Model & Layout Component Code along
  ...
  {
    topic: 'useEffect',
    key: `the async hook: Fetching data in React
  ...
  },
  {
    ...
    key: `Add useLocalStorage() to React todo
  ...
  },
  {
    ...
    key: `note on Jamstack: SPA's vs. SSR
  ...
  },
  {
    ...
    key: `CI/CD deployment pipelines
  versioning
  analytics, cookies
